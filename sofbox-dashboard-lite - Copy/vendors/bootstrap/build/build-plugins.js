...
const bsPlugins = {
  Alert: path.resolve(__dirname, 'src/alert.js'),
  Button: path.resolve(__dirname, 'src/button.js'),
  Carousel: path.resolve(__dirname, 'src/carousel.js'),
  Collapse: path.resolve(__dirname, 'src/collapse.js'),
  Dropdown: path.resolve(__dirname, 'src/dropdown.js'),
  Modal: path.resolve(__dirname, 'src/modal.js'),
  Popover: path.resolve(__dirname, 'src/popover.js'),
  ScrollSpy: path.resolve(__dirname, 'src/scrollspy.js'),
  Tab: path.resolve(__dirname, 'src/tab.js'),
  Toast: path.resolve(__dirname, 'src/toast.js'),
  Tooltip: path.resolve(__dirname, 'src/tooltip.js'),
  Util: path.resolve(__dirname, 'src/util.js')
}
const rootPath = TEST ? 'coverage/dist/' : 'js/t/'
